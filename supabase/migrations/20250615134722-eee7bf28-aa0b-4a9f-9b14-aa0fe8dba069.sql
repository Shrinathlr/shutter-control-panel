...
-- 12. Enable RLS (Row Level Security) on all main tables
...
-- 13. DROP all default policies to ensure idempotency and avoid duplicates
...
-- 14. RLS policies for all public tables (users need to be logged in and/or have role)
-- user_roles
